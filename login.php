<?php
//this is Login form page , if user is already logged in then we will not allow user to access this page by executing
//isset($_SESSION["uid"])
ob_start();
session_start();
...
<?php include('inc/container.php');?>
	...
	<h1 class="text-center my-4 py-3 text-light" id="title">Voorraad management systeem - Superbrains</h1>
