...
// ontvang alle invoerwaarden van de overzichten
...
// conn -> connect data
// public function  Initilisatie "Connected successfully<br>";       
        }
    }
  ...
  // voegt item in de database in de juiste  rijen en kollomen van "product" "categorie" en "brand"
  ...
  // Wijzigt/Update item in de database in de juiste kollomen van "product" "categorie" en "brand"
  ...
  // Verwijdert item uit de database in de juiste kollomen van "product" "categorie" en "brand"
